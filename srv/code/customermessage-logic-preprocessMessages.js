 ...
 * @Before(event = { "READ" }, entity = "cOROSZLAN_22_STUDENTH22Srv.CustomerMessages")
...
module.exports = async function(request) {
	...
	try {
		...
		customerMessages = await SELECT.from('COROSZLAN_22_STUDENTH22.CustomerMessages').forUpdate();
	} catch (error) {
