...
/**
 * 
 * @On(event = { "Action1" }, entity = "cOROSZLAN_22_STUDENTH22Srv.CustomerMessages")
...
try {
    ...
    customerMessage = await SELECT.one.from('COROSZLAN_22_STUDENTH22.CustomerMessages').where({ ID });
    if (!customerMessage) {
...
if (messageCategory === 'Technical') {
    ...
    try {
        ...
        relevantFAQs = await SELECT.from('COROSZLAN_22_STUDENTH22.ProductFAQ')
...
try {
    ...
    await UPDATE('COROSZLAN_22_STUDENTH22.CustomerMessages').set({
